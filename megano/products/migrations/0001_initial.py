    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview', models.ImageField(blank=True, null=True, upload_to=products.models.category_preview_directory_path)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('preview', models.ImageField(blank=True, null=True, upload_to=products.models.product_preview_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product', verbose_name='скидка')),
            ],
        ),
        migrations.CreateModel(
            name='ProductReviews',
            fields=[
                ...
                ('rate', models.PositiveIntegerField(blank=True, verbose_name='рейтинг')),
                ('date', models.DateField(auto_now_add=True, verbose_name='дата')),
        ...
        migrations.AddField(
            model_name='product',
            name='subcategories',
            field=models.ManyToManyField(related_name='subcategories', to='products.subcategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='tags',
