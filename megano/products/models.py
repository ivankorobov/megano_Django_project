...
class Tag(models.Model):
    ...
    short_desc = models.TextField(null=True, blank=True, verbose_name='краткое описание')


class Category(models.Model):
    name = models.CharField(max_length=120, verbose_name='название')
    short_desc = models.TextField(null=True, blank=True, verbose_name='краткое описание')
    preview = models.ImageField(null=True, blank=True, upload_to=category_preview_directory_path)
...
class Product(models.Model):
    ...
    full_description = models.TextField(null=False, blank=True, verbose_name='полное описание')
...
class ProductSale(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name='скидка')
    sale_price = models.DecimalField(default=0, max_digits=8, decimal_places=2, verbose_name='цена со скидкой')
